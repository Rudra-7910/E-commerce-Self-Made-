...
function Register() {
    ...
    const RegisterUser = async(data)=>{
        const response = await axios.post(`${import.meta.env.PROD ? 'https://e-commerce-self-made-production.up.railway.app' : 'http://localhost:3000'}/api/user/register`, data)
        return response.data
    }
    const verifyUser = async(data)=>{
        const response = await axios.post(`${import.meta.env.PROD ? 'https://e-commerce-self-made-production.up.railway.app' : 'http://localhost:3000'}/api/user/register/verify`, data)
        return response.data
    }
